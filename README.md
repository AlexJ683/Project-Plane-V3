...
1. unit testing - done
    1. figure out how to unit test with pandas -done
    ...
    2. update code structure so testinng can be done effectively -done
    3. figure out test for backend guessing it's some sort of mock -done
...
1.5 docker build/docker compose -done
2. intergration testing -done comeback to do streamlit testing if time 
...
3. system testing -hmm possibly done
