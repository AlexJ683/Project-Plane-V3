...
class web_app():
    ...
    def home_page(self):
        ...
        with right:
            ...
            fig = px.scatter(df, x="price", y="duration",
                             color="airline",
    ...
    def search_page(self):
        ...
        if flight_number:
            flight_details = self.data_processing.data[
                self.data_processing.data["flight_number"] == flight_number]
            if not flight_details.empty:
                ...
                flight_locations = self.data_processing.geo_data(
                    departure_city, arrival_city)
                if flight_locations:
                    m = folium.Map(location=[(flight_locations[
                        "latitude_departure"]
                                              + flight_locations[
                                                  "latitude_arrival"]) / 2,
                                            (flight_locations[
    ...
    def data_upload_page(self):
        ...
        if uploaded_file is not None:
            ...
            df["duration"] = df["duration"].apply(
                self.data_processing.int_to_str_duration)
